	...
	extendModel: function (Model) {
		_.extend(Model.prototype, {
			transform: function () {
				...
				md.horarioFuncionamento = "Das " + moment(md.horaAbertura, formatoEntrada).format(formatoHora) + " até " + moment(md.horaEncerramento, formatoEntrada).format(formatoHora);
...
model = Alloy.M('restaurante', exports.definition, []);

collection = Alloy.C('restaurante', exports.definition, model);
