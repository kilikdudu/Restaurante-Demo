if (!true) {
    ...
    NavigationWindow.prototype.openWindow = function (window, options) {
        ...
        if (false && options.animated !== false) {
        ...
        if (false && options.displayHomeAsUp !== false && !window.navBarHidden) {
...
exports.createNavigationWindow = function (args) {
    var navWin = true ? Ti.UI.iOS.createNavigationWindow(args) : new NavigationWindow(args);
