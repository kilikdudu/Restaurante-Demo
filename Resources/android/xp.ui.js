if (!false) {
    ...
    NavigationWindow.prototype.openWindow = function (window, options) {
        ...
        if (true && options.animated !== false) {
        ...
        if (true && options.displayHomeAsUp !== false && !window.navBarHidden) {
...
exports.createNavigationWindow = function (args) {
    var navWin = false ? Ti.UI.iOS.createNavigationWindow(args) : new NavigationWindow(args);
